                            ...
                            <?php foreach ($eleves as $eleve): ?>
                                <tr data-id="<?= $eleve['id'] ?>">
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="notes.php?id=<?= $eleve['id'] ?>" class="btn btn-sm btn-success">
            ...
            <div class="modal-body">
                <form action="requete.php" method="post" id="addForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="tel_parent" name="tel_parent" class="form-control" pattern="[0-9]{10}">
                        <small class="text-muted">Format: 23566010203 (10 chiffres)</small>
                    </div>
            ...
            <div class="modal-body">
                <form action="requete.php" method="post" id="modifyForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="modify-tel_parent" name="tel_parent" class="form-control" pattern="[0-9]{10}">
                        <small class="text-muted">Format: 23566010203 (10 chiffres)</small>
                    </div>
