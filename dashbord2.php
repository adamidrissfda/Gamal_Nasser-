    ...
    <nav class="sidebar" aria-label="Menu latéral">
        <div class="sidebar-header">
         ...
         <ul class="sidebar-menu">
            <li><a href="dashbord2.php" class="active"><i class="fas fa-home"></i><span>Accueil</span></a></li>
            <li><a href="eleve2.php"><i class="fas fa-users"></i><span>Élèves</span></a></li>
            <li><a href="enseignant2.php"><i class="fas fa-chalkboard-teacher"></i><span>Enseignants</span></a></li>
            <li><a href="classe2.php"><i class="fas fa-school"></i><span>Classes</span></a></li>
            <li><a href="matiere2.php"><i class="fas fa-book-open"></i><span>Matières</span></a></li>
            <li><a href="emploi_par_classe2.php"><i class="fas fa-calendar-alt"></i><span>Emploi du temps</span></a></li>
    ...
    <main class="main-content">
        <header>
            ...
            <div class="user-info">
                ...
                <span class="user-name"><?= htmlspecialchars($_SESSION['admin_name'] ?? 'Enseignant') ?></span>
            </div>
        </header>
        ...
        <section class="content">
            ...
            <div class="welcome-container">
                <div class="welcome-header">
                    <h2 class="welcome-title">Bienvenue, <?= htmlspecialchars($_SESSION['admin_name'] ?? 'Enseignant') ?> !</h2>
                    ...
                    <ul class="recent-list">
                        <?php foreach ($recentStudents as $student): ?>
                            <li class="recent-item">
                                ...
                                <a href="eleve2.php?id=<?= htmlspecialchars($student['id']) ?>" class="view-link" title="Voir détails">
